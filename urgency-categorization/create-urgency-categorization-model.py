...
# Map categories to labels (0 = High, 1 = Medium, 2 = Low)
category_to_label = {"High Urgency": 0, "Medium Urgency": 1, "Low Urgency": 2}
...
training_args = TrainingArguments(
    output_dir='./results',
    num_train_epochs=5,  # Reduced to 5 to avoid overfitting on small dataset
...
print("Model and tokenizer saved to './urgency_classifier_model'.")